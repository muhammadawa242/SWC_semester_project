...
//props are properties, i.e. of parent element <div message=""/> here for child <div>{props.message}</div>. see application for templating 
const props = {
    className: "my-svg",
    // other props...
};
export default function logo() {
    return(
        <div className="text-blue-700 font-bold text-xl flex gap-2 p-4 font-mono">
            <svg
                viewBox="0 0 512 512"
                fill="currentColor"
                height="1.1em"
